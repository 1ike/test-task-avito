...
//     id: 28723534,
//     score: 1,
//     text: 'Ok gang, high quality problem time for Friday afternoon'
//       + '<p>I spent &gt;12 years building a company with 2 other co-founders '
//       + 'and a lot of investor money'
//       + '<p>We just wrapped up a year long process of getting acquired for unicorn $$$'
//       + '<p>I have a two year earn out that is heavily backend weighted, '
//       + 'eg about 75% of my total compensation will be in the last year.'
//       + '<p>The money is &quot;guaranteed&quot; but I am responsible for showing up, '
//       + 'driving the company integration, etc<p>Here&#x27;s the rub - I just got finished'
//       + ' with my first month of DD, lawyers, compliance meetings, etc.<p>It&#x27;s clear '
//       + 'that the next'
//       + ' two years of my life are going to be captive to corporate bull@#!t, '
//       + 'bizarre power grabs,'
//       + ' etc - all the stuff I&#x27;ve spent my life avoiding like the plague '
//       + 'by being an entrepreneur'
//       + '<p>Integration to the acquirer meant &quot;fitting a square peg into a round hole&quot;'
//       + '<p>I went into this with open eyes, but it is exhausting and demoralizing'
//       + '<p>I am grateful for the opportunity, I am also old, tired, '
//       + 'and ready for a break not two more years of toeing the line :)'
//       + '<p>What have others done in similar situations?',
//     time: 1633123428,
    ...
    getNewStories: builder.query<StoryInterface[], void>({
      async queryFn(_arg, _queryApi, _extraOptions, fetchWithBQ) {
        ...
        return error
          ...
          : {
            data: results.map(
              ({ data: story }: any) => ({ ...story, time: transformDate(story.time) }),
            ) as StoryInterface[],
          };
        // : { data: data.map((story) => ({ ...story, time: transformDate(story.time) })) };
      },
    }),
  }),
});
